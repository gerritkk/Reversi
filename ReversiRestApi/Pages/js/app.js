...
$(document).ready(function () {
  console.log("ready!");
  $r = new FeedbackWidget('feedback-danger');
});
...
Game.Model = function () {
  ...
  var privateInit = function privateInit() {
    console.log("private Game.Model function.");
    var intervalID = window.setInterval(_getGameState, 2000); // gamestate elke 2 seconden
  };
